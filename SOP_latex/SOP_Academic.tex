...
The University of Michigan-Dearborn provides the rigorous theoretical coursework and collaborative research environment required to pursue my synergistic vision. Specifically, my trajectory aligns perfectly with the laboratory of Prof. Van-Hai Bui, driven by our shared focus on autonomous multi-agent energy management. Building upon the deterministic optimization foundation detailed previously, I aim to contribute directly to his learning-based policies, such as FairMarket-RL and XRL-LLM, by embedding my mathematical models as physics-informed safety filters.

Beyond Professor Bui's laboratory, I am also keen to engage with Dr. Wencong Su and Dr. Junho Hong, whose complementary expertise perfectly aligns with my dual-pillar research vision. Dr. Su's groundbreaking work---particularly his collaborative research with Prof. Bui on utilizing LLMs for Economic Dispatch---would deepen my understanding of system-level AI integration and large-scale energy management. In parallel, Dr. Hong's focus on Physics-Informed anomaly detection and digital substations would strengthen my foundation in component-level physical constraints and grid security. Together, these viewpoints would allow me to develop a cohesive research approach that bridges high-level learning algorithms and ground-level physical resilience, equipping me to architect autonomous power systems with both computational scalability and rigorous safety.
