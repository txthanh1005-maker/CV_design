...
I am completing my Bachelor’s degree in Electrical Engineering at Hanoi University of Science and Technology (HUST), specializing in algorithmic control for modern power systems. At the Power Grid and Renewable Energy (PGRE) Laboratory, I develop distributed mathematical optimization models for decentralized energy management and peer-to-peer (P2P) trading. This analytical foundation directly informed my graduation thesis, where I engineered real-time automated fault responses to ensure resilience across networked microgrids.
