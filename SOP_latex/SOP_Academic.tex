...
As a final-year Electrical Engineering student at Hanoi University of Science and Technology (HUST), my research at the Power Grid and Renewable Energy (PGRE) Laboratory focuses on developing distributed mathematical optimization models for decentralized energy management. While this foundation drove my graduation thesis on microgrid resilience, I recognized that classical optimization alone faces critical limitations when scaling to the real-time computational demands of modern power systems. To overcome these computational bottlenecks, I seek to deepen my expertise in scalable, cyber-physical control systems. The Ph.D. program at UM-Dearborn directly addresses this need, providing the exact framework necessary to become a highly specialized research engineer capable of designing decentralized architectures for high renewable penetrations.
...
Ultimately, overcoming strict convergence challenges and collaborating across research groups has forged a resilient analytical foundation. Equipped with this physics-based modeling capability, I am prepared to deploy this expertise to drive scalable, real-time grid operations within your doctoral ecosystem.
